...
public final class PromptTemplates {
    ...
    "- Comment on issues that could cause problems in production or maintenance.",
    "- Provide constructive feedback on code improvements and potential issues.",
    "- Include both critical issues and suggestions for improvement.",
    "- Do not give positive comments or compliments unless specifically relevant.",
